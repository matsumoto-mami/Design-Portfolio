				...
				<div class="container-fluid w-100">
					...
					<div class="row col-xl-8 col-lg-8 col-md-10 mx-auto text-left">
						<p class="about-para">
							...
							手法にとらわれないモノづくりをしていきたい。そんな思いで写真・映像制作・Webデザインとコーディングを独学で学び、海外営業職に就いていたアパレルメーカーを退社。現在フリーランスフォトグラファーとして関西で活動しながら、デザイナーを目指し、日々制作に励んでいます。
				...
				<div class="container-fluid w-100">
					<h2 id="contact" class="section-title mb-5" data-color="#1e2022">
						...
						<div class="row col-xl-8 col-lg-8 col-md-10 mx-auto text-center">
							<p class="about-para">
								この度、もっと自分を飛躍させたいと覚悟を決め、上京します。<br>

素敵なデザイン事務所様の元で修行し、世界に通用するクリエイターを目指します。
面白いもの、魅力的なもの、愛されるものを沢山作りたいです。一生懸命働きます。<br>

私と一緒に何か作りたいと思ってくださった方、是非メールをいただけると嬉しいです。<br>
宜しくお願い致します！
							</p>
...
<!--modalの中身-->
	<div id="modal" class="modal-none">
		...
		<div class="modal-project-about mb-5">
			私のフォトグラファーとしてのポートフォリオサイトです。そして、私が作った初めて作ったWebサイトです。制作期間は約2ヶ月かかりました。デザインはシンプルに、配色は白をベースにし、写真が目立つようにしました。Portfolioページにある、jQurryのmasonryプラグインを使い、サイズの違う写真をタイルレイアウトで配置しました。
			独学ながらなんとか形にできたことが、今の糧になっています。progateやドットインストールにはとてもお世話になりました。
...
<!--modal3の中身-->
	<div id="modal3" class="modal-none">
		...
		<div class="modal-project-about mb-5">
			私のデザイナーとしてのポートフォリオサイトです、このサイトは、Bootstrap4 / Javascriptの実装に力を入れました。aboutページで沢山の好きなもの、趣味を見せたかったので、自動でスライドしていくスライダー機能を採用。スライドしていくアイコンと同時に文字も切り替わるようjqueryで実装し、より伝わりやすくなるよう工夫しました。背景グラデーションを綺麗にみせたかった為、スクロールするごとに背景色が変化させています。目的のためにどういう動きをつけるか考え、調べつつ実装していくことがとても楽しかったです。デザインはヒーローイメージである太陽の写真に合うように考え、シングルカラムでミニマルなデザインにしました。
...
<!--modal4の中身-->
	...
	<div id="modal6" class="modal-none">
		...
		<div class="modal-project-about mb-5">
			噛めば噛むほど味が出るイカを、使えば使うほど味が出る革で制作したいと思い、ストラップにしました。型紙から失敗の連続で、立体的な形にするまで20回以上試作を重ねました。素材は変色しやすいヌメ革を使用し、使い込むほどに色の変化を楽しんでいただけるようにしました。受注生産していましたが全く売れませんでした。<br>
			*ハンドメイドなので個体差があります。
	...
	<div id="modal12" class="modal-none">
		...
		<div class="modal-project-about mb-5">
			友人と起業したweb制作会社「zimotto」の名刺を作成しました。株式会社なのでかっちりした感じを出しながらも、女性２人の企業ということで、優しさを出す為、紙はマット紙を選び、角丸加工を施しました。表面には２人の地元、枚方の河川で撮影した２人の後ろ姿を使用し、裏面はわかりやすくデザインすることを心がけました。親しみやすさを込めて、名前の横にはあだ名を記載しています。
